...
export const PluginTemplateUcApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    pluginTemplateOverviewForUc: async (
...
export const PluginTemplateUcApiFp = function (configuration?: Configuration) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    async pluginTemplateOverviewForUc(
      options?: RawAxiosRequestConfig,
      ...
      const localVarOperationServerBasePath =
        operationServerMap['PluginTemplateUcApi.pluginTemplateOverviewForUc']?.[
 ...
 * @export
 */
export const PluginTemplateUcApiFactory = function (
  ...
  return {
    ...
    pluginTemplateOverviewForUc(
      ...
      return localVarFp
        .pluginTemplateOverviewForUc(options)
...
export class PluginTemplateUcApi extends BaseAPI {
  ...
  public pluginTemplateOverviewForUc(options?: RawAxiosRequestConfig) {
    return PluginTemplateUcApiFp(this.configuration)
      .pluginTemplateOverviewForUc(options)
