...
public class PluginTemplatePlugin extends BasePlugin {
    ...
    public void start() {
        schemeManager.register(PluginTemplateRecord.class, indexSpecs -> {
            ...
            indexSpecs.add(IndexSpecs.<PluginTemplateRecord, Boolean>single("enabled", Boolean.class)
                .indexFunc(PluginTemplateRecord::getEnabled));
            indexSpecs.add(IndexSpecs.<PluginTemplateRecord, Integer>single("priority", Integer.class)
                .indexFunc(PluginTemplateRecord::getPriority));
            indexSpecs.add(IndexSpecs.<PluginTemplateRecord, String>single("publishTime", String.class)
                .indexFunc(PluginTemplateRecord::getPublishTime));
